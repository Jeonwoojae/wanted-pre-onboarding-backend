package com.example.wantedpreonboardingbackend.global.error;
...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleConversionFailedException(ConversionFailedException e) {
        ...
        final ErrorResponse response = ErrorResponse.of(ErrorCode.CONVERSION_FAILED);
